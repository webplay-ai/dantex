defmodule Dantex.Validator do
  ...
  This can be used in conjuction with the `:max_retries` parameter to `Agent.chat_completion/1` to retry the completion until it passes your validation.

  ## Examples

    defmodule Dantex.Demos.SpamPrediction do
      use Ecto.Schema
    ...
    iex> Dantex.Response.validate(
    ...>   response_format: Instructor.Demos.SpamPrediction,
    ...>   messages: [
    ...>     %{
    ...>       role: "user",
  ...
  defmacro __using__(_) do
    quote do
      @behaviour Dantex.Validator

      import Dantex.Validator
    end
  end
