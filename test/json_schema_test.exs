...
defmodule Dantex.JSONSchemaTest do
  ...
  test "schema" do
    ...
    expected_json_schema =
      %{
        ...
        "required" => ["string"],
        "title" => "Dantex.JSONSchemaTest.Demo",
        "type" => "object",
  ...
  test "includes documentation" do
    defmodule DemoWithDoc do
      ...
      def __llm_doc__, do: @llm_doc
    end

    json_schema =
      JSONSchema.from_ecto_schema(DemoWithDoc)
      |> Jason.decode!()
    ...
    expected_json_schema =
      %{
        ...
        "required" => ["string"],
        "title" => "Dantex.JSONSchemaTest.DemoWithDoc",
        "type" => "object",
        "additionalProperties" => false
      }
  ...
  test "embedded schemas" do
    ...
    expected_json_schema = %{
      "$defs" => %{
        "Dantex.JSONSchemaTest.Embedded" => %{
          "description" => "",
          "properties" => %{
            "string" => %{
              "title" => "string",
          ...
          "required" => ["string"],
          "title" => "Dantex.JSONSchemaTest.Embedded",
          "type" => "object",
          "additionalProperties" => false
        }
      },
      ...
      "properties" => %{
        "embedded" => %{
          "$ref" => "#/$defs/Dantex.JSONSchemaTest.Embedded",
          "title" => "embedded"
        }
      },
      "required" => ["embedded"],
      ...
      %{
        "$defs" => %{
          "Dantex.JSONSchemaTest.Child" => %{
            ...
            "required" => ["id", "string"],
            "title" => "Dantex.JSONSchemaTest.Child",
            "type" => "object",
            "additionalProperties" => false
          }
        },
        "description" => "",
        "properties" => %{
          "child" => %{"$ref" => "#/$defs/Dantex.JSONSchemaTest.Child"},
          "id" => %{
            "title" => "id",
            "type" => "integer",
            "description" => "Integer, e.g. 1"
  ...
  test "has_many" do
    ...
    expected_json_schema = %{
      ...
      "properties" => %{
        "children" => %{
          "items" => %{"$ref" => "#/$defs/Dantex.JSONSchemaTest.Child"},
          "title" => "Dantex.JSONSchemaTest.Child",
          "type" => "array"
        },
        "id" => %{
